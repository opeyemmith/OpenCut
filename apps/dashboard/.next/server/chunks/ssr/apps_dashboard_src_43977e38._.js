...
"[project]/apps/dashboard/src/adapters/indexed-db.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$idb$40$8$2e$0$2e$3$2f$node_modules$2f$idb$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.bun/idb@8.0.3/node_modules/idb/build/index.js [app-ssr] (ecmascript)");
;
class IndexedDBAdapter {
    dbName = "clipfactory-db";
    version = 1;
    async getDB() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$idb$40$8$2e$0$2e$3$2f$node_modules$2f$idb$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openDB"])(this.dbName, this.version, {
            upgrade (db) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/dashboard/src/adapters/indexed-db.ts [app-ssr] (ecmascript)");
;
;
const useTemplateStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$zustand$40$5$2e$0$2e$6$2b$09a4a3ac15cb54ba$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        templates: [],
        projects: [],
        isLoading: false,
        ...
        addTemplate: (template)=>{
            ...
            // Async DB update
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].set(`templates:${template.id}`, template);
        },
        updateTemplate: (id, updates)=>{
            set((state)=>{
                ...
                if (updatedItem) __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].set(`templates:${id}`, updatedItem);
                return {
        ...
        deleteTemplate: (id)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].delete(`templates:${id}`);
        },
        ...
        addProject: (project)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].set(`projects:${project.id}`, project);
        },
        updateProject: (id, updates)=>{
            set((state)=>{
                ...
                if (updatedItem) __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].set(`projects:${id}`, updatedItem);
                return {
        ...
        deleteProject: (id)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].delete(`projects:${id}`);
        },
        ...
        loadInitialData: async ()=>{
            ...
            try {
                const templateKeys = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].list("templates");
                const projectKeys = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].list("projects");
                const templates = await Promise.all(templateKeys.map((key)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].get(key)));
                const projects = await Promise.all(projectKeys.map((key)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$dashboard$2f$src$2f$adapters$2f$indexed$2d$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dbAdapter"].get(key)));
...
//# sourceMappingURL=apps_dashboard_src_43977e38._.js.map